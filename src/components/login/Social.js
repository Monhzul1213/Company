  ...
  return (
    <div>
      <div className='social_header'>
        ...
        <p className='social_label'>{t('visit')}</p>
        <div className='social_line' />
      </div>
      <div className='social_row'>
        <a className='social_link' target="blank" href='https://bit.ly/3fqmY3F'>
          <GrFacebookOption className='social' style={{fontSize: 22, color: '#4267B2'}} />
        </a>
        <a className='social_link' target="blank" href='https://twitter.com/ultimateerp'>
          <DynamicAIIcon name='AiOutlineTwitter' className='social' style={{color: '#1DA1F2'}} />
        </a>
        <a className='social_link' target="blank" href='https://bit.ly/3SQ2Mqt'>
